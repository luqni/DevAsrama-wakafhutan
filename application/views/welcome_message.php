...
<script type="text/javascript" src="<?php echo base_url(); ?>assets/js/Vegur_700.font.js"></script>
<script type="text/javascript" src="<?php echo base_url(); ?>assets/js/Vegur_400.font.js"></script>
<script type="text/javascript" src="<?php echo base_url(); ?>assets/js/Vegur_300.font.js"></script>
...
<script type="text/javascript" src="<?php echo base_url(); ?>assets/js/backgroundPosition.js"></script>
...
<div class="body1">
  <div class="main">
    ...
    <header>
      <div class="wrapper">
        <h1><a href="<?php echo base_url(); ?>" id="logo">Wakaf Hutan</a></h1>
        <nav>
          <ul id="top_nav">
            <li><a href="index.html"><img src="<?php echo base_url(); ?>assets/images/top_icon1.gif" alt=""></a></li>
            <li><a href="#"><img src="<?php echo base_url(); ?>assets/images/top_icon2.gif" alt=""></a></li>
            <li class="end"><a href="contact.html"><img src="<?php echo base_url(); ?>assets/images/top_icon3.gif" alt=""></a></li>
          </ul>
        </nav>
        <nav>
          <ul id="menu">
      ...
      <div class="slider">
        <ul class="items">
          <li> <img src="<?php echo base_url(); ?>assets/images/img1.png" alt="">
            <div class="banner">
          ...
          <li> <img src="<?php echo base_url(); ?>assets/images/img2.png" alt="">
            <div class="banner">
              <div class="wrapper"><span>“TOGETHER we can CHANGE“</span></div>
              <div class="wrapper"><span></span></div>
            </div>
          </li>
          <li> <img src="<?php echo base_url(); ?>assets/images/img3.png" alt="">
            <div class="banner">
              <div class="wrapper"><span>“Let's Donation“</span></div>
              <div class="wrapper"><span></span></div>
            </div>
          </li>
        </ul>
        <ul class="pagination">
          <li id="banner1"><a href="#">Make<span>Campaign</span></a></li>
          <li id="banner2"><a href="#">join<span>volunteer</span></a></li>
          <li id="banner3"><a href="#">Let's<span>Donate</span></a></li>
        </ul>
      </div>
    </header>
    <!-- / header -->
