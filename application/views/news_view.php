  ...
  <div class="main">
    ...
    <header>
      <div class="wrapper">
        ...
        <nav>
          <ul id="top_nav">
            <li><a href="<?php echo base_url(); ?>"><img src="<?php echo base_url(); ?>/assets/images/top_icon1.gif" alt=""></a></li>
            <li><a href="#"><img src="<?php echo base_url(); ?>/assetsimages/top_icon2.gif" alt=""></a></li>
